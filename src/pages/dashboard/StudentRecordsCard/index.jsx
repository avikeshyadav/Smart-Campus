...
const StudentRecordsCard = () => (
  <div className="rounded-2xl border border-slate-800 bg-slate-900/90 p-4 shadow-lg">
    ...
    <p className="mt-3 text-sm leading-6 text-slate-400">Manage student profiles, admissions, and academic records.</p>
  </div>
);

export default StudentRecordsCard;
